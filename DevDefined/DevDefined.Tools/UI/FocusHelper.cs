// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FocusHelper.cs" company="">
//   
// </copyright>
// <summary>
...
namespace DevDefined.Tools.UI
{
    ...
    public static class FocusHelper
    {
        ...
        /// </summary>
        /// <param name="form">
        /// The form to retain focus on
        /// </param>
        /// <param name="seconds">
        /// The number of seconds to retain focus for
        /// </param>
        /// <remarks>
        /// This method uses the <see cref="ThreadPool"/> to asynchronously maintain focus.
        /// </remarks>
