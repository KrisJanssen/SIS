...
namespace KUL.MDS.Hardware
{
    ...
    public sealed class CommPort
    {
        ...
        public void Open()
        {
            ...
            try
            {
                _serialPort.PortName = CommSettings.Port.PortName;
                _serialPort.BaudRate = CommSettings.Port.BaudRate;
                _serialPort.Parity = CommSettings.Port.Parity;
                _serialPort.DataBits = CommSettings.Port.DataBits;
                _serialPort.StopBits = CommSettings.Port.StopBits;
                _serialPort.Handshake = CommSettings.Port.Handshake;
