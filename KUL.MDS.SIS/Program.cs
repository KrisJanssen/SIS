...
namespace KUL.MDS.SIS
{
    internal sealed class Startup
    {
        ...
        /// </summary>
        /// <param name="__iw32wndParent"></param>
        /// <param name="__bRequireAdmin"></param>
        /// <param name="__sArgs"></param>
        ...
        public static void StartNewInstance(IWin32Window __iw32wndParent, string __sFileName)
        {
            ...
            StartNewInstance(__iw32wndParent, false, new string[1] { _sArg });
        }
        ...
        private void StartStage2()
        {
            ...
            //else
            //{
            SingleInstanceManager _simgrsingleInstanceManager = new SingleInstanceManager(InvariantStrings.SingleInstanceMonikerName);
