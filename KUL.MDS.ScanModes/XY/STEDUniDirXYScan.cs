// --------------------------------------------------------------------------------------------------------------------
// <copyright file="STEDUniDirXYScan.cs" company="Kris Janssen">
...
namespace SIS.ScanModes.XY
{
    ...
    /// Object supplies the necessary coordinates to a stage based upon the physical parameters that fully describe a unidirectional STED scan
    /// </summary>
    [ScanMode("STED Unidirectional XY Scan")]
    public class STEDUniDirXYScan : Scanmode
    {
        #region Constructors and Destructors

        /// <summary>
        /// Initializes a new instance of the <see cref="STEDUniDirXYScan"/> class. 
                ...
                __dCycleTime)
        {
            ...
            this.m_dXGLfwd = (((double)this.m_dXScanSizeNm / (double)this.m_iImageWidthPx)
                              * (double)(this.m_iImageWidthPx + this.m_iXOverScanPx))
                             * ((double)(this.m_iXCPfwd - this.m_iXPSfwd)
                                / (double)(this.m_iXCPfwd - (2 * this.m_iXPSfwd)));
            ...
            // Dead time where the piezo is allowed to settle before a movement.
            this.m_iYPAfwd = this.m_iXPTfwd * 2 + this.m_iXPTbckwd - this.m_iXPEfwd;
            ...
            this.m_iTrig2End = this.m_iXPTfwd + this.m_iXPTbckwd + this.m_iXPAfwd + this.m_iXPSfwd
                               + this.m_iImageWidthPx + this.m_iXOverScanPx;

            // Trigger line three is used for correct shutter switching. It is therefore a level trigger.
            ...
            // this.m_iTrig3Start = this.m_iXPAfwd; // This is the 'old' setting 
        ...
        protected override void CalculateNMScanCoordinates()
        {
            ...
            double[] _dY = ScanUtility.LinSegment(this.m_iYPAfwd, this.m_iYPSfwd, this.m_iYCPfwd, 0.0, this.m_dYGLfwd);
