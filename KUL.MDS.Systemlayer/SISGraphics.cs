...
namespace SIS.Systemlayer
{
    ...
    using SIS.Systemlayer.GpcWrapper;
    ...
    /// thunk straight to equivelants in System.Drawing.Graphics.
    /// </summary>
    public static class SISGraphics
    {
        #region Constants
        ...
        public static GraphicsPath ClipPath(GraphicsPath subjectPath, CombineMode combineMode, GraphicsPath clipPath)
        {
            ...
            Polygon basePoly = new GpcWrapper.Polygon(subjectPath);

            GraphicsPath clipClone = (GraphicsPath)clipPath.Clone();
            clipClone.CloseAllFigures();
            Polygon clipPoly = new GpcWrapper.Polygon(clipClone);
            clipClone.Dispose();

            Polygon clippedPoly = GpcWrapper.Polygon.Clip(combineMode, basePoly, clipPoly);
        ...
        /// </summary>
        /// <param name="pi">
        /// The PropertyItem to clone.
        /// </param>
        /// <returns>
        /// A copy of the given PropertyItem.
        /// </returns>
        ...
        /// </summary>
        /// <param name="dst">
        /// The Graphics context to draw the bitmap on to.
        /// </param>
        /// <param name="dstRect">
        /// The clipping rectangle in destination coordinates.
        /// </param>
        /// <param name="dstMatrix">
        /// The transformation matrix to apply. This is only used to transform the upper-left corner of dstRect.
        /// </param>
        /// <param name="srcBitmapHandle">
        /// The handle to the bitmap obtained from Memory.AllocateBitmap().
        /// </param>
        /// <param name="srcOffsetX">
        /// The left edge of the source bitmap to draw from.
        /// </param>
        /// <param name="srcOffsetY">
        /// The top edge of the source bitmap to draw from.
        /// </param>
        public static unsafe void DrawBitmap(
            Graphics dst, 
            Rectangle dstRect, 
            Matrix dstMatrix, 
            ...
            int srcOffsetY)
        {
            ...
            Point[] points = new[] { dstRect.Location };
        ...
        /// </param>
        /// <param name="points">
        /// The points to draw. Lines are drawn between every point N to point N+1.
        /// </param>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="pi">
        /// The PropertyItem to serialize.
        /// </param>
        /// <returns>
        /// A string that may be later deserialized using DeserializePropertyItem.
        /// </returns>
        /// <remarks>
        /// Note to implementors: The format for the serialized data is intentionally opaque for programmatic users
        /// of this class. However, since this data goes into .PDN files, it must be carefully maintained. See
        ...
        /// </exception>
        internal static unsafe void GetRegionScans(IntPtr hRgn, out Rectangle[] scans, out int area)
        {
            uint bytes = 0;
            ...
            if (bytes == 0)
            {
                throw new Win32Exception(
                    error, 
                    "GetRegionData returned " + bytes.ToString() + ", GetLastError() = " + error.ToString());
            }
