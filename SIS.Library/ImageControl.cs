...
namespace KUL.MDS.Library
{
    ...
    public partial class ImageControl : UserControl
    {
        ...
        {
            this.m_dXPositionSelected = ((double)this.m_rlrHRuler.Value / (double)this.m_drwcnvDrawCanvas.Image.Width) * (double)this.m_dPhysImageWidth;
            this.m_dYPositionSelected = ((double)this.m_rlrVRuler.Value / (double)this.m_drwcnvDrawCanvas.Image.Height) * (double)this.m_dPhysImageHeight;
            if (this.OnPositionSelected != null)
            {
                this.OnPositionSelected(this, new EventArgs());
                Tracing.Ping("OnPositionSelected raised here!");
            }
        }
    }
