namespace SIS.Library
{
   partial class ImageControl
   {
      ...
      private void InitializeComponent()
      {
          ...
          this.m_rlrVRuler = new SIS.Library.Ruler();
          this.m_rlrHRuler = new SIS.Library.Ruler();
          this.m_drwcnvDrawCanvas = new SIS.Library.DrawCanvas();
          this.SuspendLayout();
          // 
          // m_scrlbrVScrollBar
          // 
          ...
          this.m_rlrVRuler.MeasurementUnit = SIS.Library.MeasurementUnit.Pixel;
          ...
          this.m_rlrHRuler.MeasurementUnit = SIS.Library.MeasurementUnit.Pixel;
