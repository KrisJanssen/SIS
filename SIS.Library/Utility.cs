...
namespace SIS.Library
{
    ...
    public sealed partial class Utility
    {
        ...
        //            string format = SISResources.GetString("WebExceptionStatus.ProtocolError.Format");
        ...
        //            errorMessage = SISResources.GetString(stringName);
        //            break;
        //    }
        ...
        //    {
        //        Utility.ErrorBox(owner, SISResources.GetString("WIA.Error.EnableMe"));
        //    }
        //    else
        //    {
        //        Utility.ErrorBox(owner, SISResources.GetString("WIA.Error.UnableToLoad"));
        //    }
        //}
        ...
        //{
        //    MessageBox.Show(parent, message, SISInfo.GetBareProductName(), MessageBoxButtons.OK, MessageBoxIcon.Error);
        //}

        //public static DialogResult ErrorBoxOKCancel(IWin32Window parent, string message)
        //{
        //    return MessageBox.Show(parent, message, SISInfo.GetBareProductName(), MessageBoxButtons.OKCancel, MessageBoxIcon.Error);
        //}

        //public static void InfoBox(IWin32Window parent, string message)
        //{
        //    MessageBox.Show(parent, message, SISInfo.GetBareProductName(), MessageBoxButtons.OK, MessageBoxIcon.Information);
        //}

        //public static DialogResult InfoBoxOKCancel(IWin32Window parent, string message)
        //{
        //    return MessageBox.Show(parent, message, SISInfo.GetBareProductName(), MessageBoxButtons.OKCancel, MessageBoxIcon.Information);
        //}

        //public static DialogResult AskOKCancel(IWin32Window parent, string question)
        //{
        //    return MessageBox.Show(parent, question, SISInfo.GetBareProductName(), MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
        //}

        //public static DialogResult AskYesNo(IWin32Window parent, string question)
        //{
        //    return MessageBox.Show(parent, question, SISInfo.GetBareProductName(), MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        //}

        //public static DialogResult AskYesNoCancel(IWin32Window parent, string question)
        //{
        //    return MessageBox.Show(parent, question, SISInfo.GetBareProductName(), MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
        //}
        ...
        //public static void ShowHelp(Control parent)
        //{
        //    string[] locales = SISResources.GetLocaleNameChain();
        //    const string indexHtml = "index.html";
        //    string baseDir = SISInfo.GetApplicationDir();
        ...
        //        {
        //            SISInfo.OpenUrl(parent, indexHtmlPath);
        //            return;
        //        }
        //    }
        ...
        //    {
        //        SISInfo.OpenUrl(parent, lastChancePath);
        //    }
        //    else
        //    {
        //        // TODO: error
