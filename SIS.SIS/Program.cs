...
namespace SIS
{
    ...
    internal sealed class Startup
    {
        ...
        /// The m_s args.
        /// </summary>
        private readonly string[] m_sArgs;
        ...
        public static bool CloseApplication()
        {
            ...
            var _lAllFormsButMainForm = new List<Form>();

            // Get a list of all Modal Forms except the main form.
            foreach (Form form in Application.OpenForms)
            {
                if (form.Modal && !ReferenceEquals(form, m_strtInstance.m_mfMainForm))
                {
        ...
        public static string GetCrashLogHeader()
        {
            ...
            var headerSW = new StringWriter(headerSB);
        ...
        public static void StartNewInstance(IWin32Window __iw32wndParent, bool __bRequireAdmin, string[] __sArgs)
        {
            ...
            var _sbAllArgs = new StringBuilder();
        ...
        {
            var openForms = new ArrayList(Application.OpenForms);
            ...
            var openForms2 = new ArrayList(Application.OpenForms);
        ...
        private static void UnhandledException(Exception ex)
        {
            ...
            using (var stream = new StreamWriter(fullName, true))
            {
            ...
            try
            {
                errorFormat = Resources.GetString("Startup.UnhandledError.Format");
            }
            catch (Exception)
            {
        ...
        private static void WriteCrashLog(Exception ex, TextWriter stream)
        {
            ...
            try
            {
                ...
                catch (Exception ex1)
                {
                    fullAppName = Application.ProductVersion
                                  + ", --- Exception while calling SISInfo.GetFullAppName(): " + ex1
                                  + Environment.NewLine;
                }
                ...
                {
                    timeOfCrash = "--- Exception while populating timeOfCrash: " + ex2 + Environment.NewLine;
                }
                ...
                {
                    appUptime = "--- Exception while populating appUptime: " + ex13 + Environment.NewLine;
                }
                ...
                {
                    osVersion = "--- Exception while populating osVersion: " + ex3 + Environment.NewLine;
                }
                ...
                {
                    osRevision = "--- Exception while populating osRevision: " + ex4 + Environment.NewLine;
                }
                ...
                {
                    osType = "--- Exception while populating osType: " + ex5 + Environment.NewLine;
                }
                ...
                {
                    processorNativeArchitecture = "--- Exception while populating processorNativeArchitecture: " + ex6
                                                  + Environment.NewLine;
                }
                ...
                {
                    clrVersion = "--- Exception while populating clrVersion: " + ex7 + Environment.NewLine;
                }
                ...
                {
                    fxInventory = "--- Exception while populating fxInventory: " + ex30 + Environment.NewLine;
                }
                ...
                {
                    processorArchitecture = "--- Exception while populating processorArchitecture: " + ex8
                                            + Environment.NewLine;
                }
                ...
                {
                    cpuName = "--- Exception while populating cpuName: " + ex9 + Environment.NewLine;
                }

                try
                {
                    cpuCount = Processor.LogicalCpuCount + "x";
                }
                catch (Exception ex10)
                {
                    cpuCount = "--- Exception while populating cpuCount: " + ex10 + Environment.NewLine;
                }

                try
                {
                    cpuSpeed = "@ ~" + Processor.ApproximateSpeedMhz + "MHz";
                }
                catch (Exception ex16)
                {
                    cpuSpeed = "--- Exception while populating cpuSpeed: " + ex16 + Environment.NewLine;
                }
                ...
                try
                {
                    ...
                    for (int i = 0; i < featureNames.Length; ++i)
                    {
                        ...
                        var feature = (ProcessorFeature)Enum.Parse(typeof(ProcessorFeature), featureName);
                ...
                {
                    cpuFeatures = "--- Exception while populating cpuFeatures: " + ex17 + Environment.NewLine;
                }
                ...
                {
                    totalPhysicalBytes = "--- Exception while populating totalPhysicalBytes: " + ex11
                                         + Environment.NewLine;
                }
                ...
                {
                    dpiInfo = "--- Exception while populating dpiInfo: " + ex19 + Environment.NewLine;
                }

                try
                {
                    localeName = "pdnr.c: " + Resources.Culture.Name + ", hklm: "
                ...
                {
                    localeName = "--- Exception while populating localeName: " + ex14 + Environment.NewLine;
                }
                ...
                {
                    inkInfo = "--- Exception while populating inkInfo: " + ex15 + Environment.NewLine;
                }
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        var lastUpdateCheckTime = new DateTime(lastUpdateCheckTimeTicks);
                ...
                {
                    updaterInfo = "--- Exception while populating updaterInfo: " + ex17 + Environment.NewLine;
                }
                ...
                {
                    featuresInfo = "--- Exception while populating featuresInfo: " + ex18 + Environment.NewLine;
                }

                try
                {
                    var assembliesInfoSB = new StringBuilder();
                ...
                {
                    assembliesInfo = "--- Exception while populating assembliesInfo: " + ex16 + Environment.NewLine;
                }
            }
            catch (Exception ex12)
            {
                stream.WriteLine("Exception while gathering app and system info: " + ex12);
            }
            ...
            else
            {
                ...
                {
                    otherEx = ((ReflectionTypeLoadException)ex).LoaderExceptions;
                }
        ...
        private bool CheckForImportantFiles()
        {
            ...
            {
                "SIS.Base.dll", "SIS.Data.dll", "SIS.Hardware.dll", "SIS.Library.dll", 
                "SIS.MDITemplate.dll", "SIS.Base.dll", "SIS.AppResources.dll", 
                "SIS.ScanModes.dll", "SIS.SerialTerminal.dll", "SIS.SystemLayer.dll", 
                "SIS.Validation.dll", "SIS.WPFControls.dll", "ZedGraph.dll", "AForge.dll", 
                "AForge.Imaging.dll", "AForge.Math.dll"
            };
            ...
            foreach (string _sRequiredFile in _sRequiredFiles)
            {
                ...
                try
                {
                    ...
                    var _fnfoFileInfo = new FileInfo(_sPathName);
        ...
        private void StartStage2()
        {
            ...
            if (locale != null)
            {
                try
                {
                    var ci = new CultureInfo(locale, true);
            ...
            // else
            // {
            var _simgrsingleInstanceManager = new SingleInstanceManager(InvariantStrings.SingleInstanceMonikerName);
