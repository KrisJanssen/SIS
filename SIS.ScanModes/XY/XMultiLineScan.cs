// --------------------------------------------------------------------------------------------------------------------
// <copyright file="XMultiLineScan.cs" company="Kris Janssen">
...
namespace SIS.ScanModes.XY
{
    ...
    /// Object supplies the necessary coordinates to a stage based upon the physical parameters that fully describe a unidirectional scan
    /// </summary>
    [ScanMode("X Multi Line Scan")]
    public class XMultiLineScan : Scanmode
    {
        #region Constructors and Destructors

        /// <summary>
        /// Initializes a new instance of the <see cref="XMultiLineScan"/> class. 
