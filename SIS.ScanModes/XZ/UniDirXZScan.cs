// --------------------------------------------------------------------------------------------------------------------
// <copyright file="UniDirXZScan.cs" company="Kris Janssen">
...
namespace SIS.ScanModes.XZ
{
    ...
    /// Object supplies the necessary coordinates to a stage based upon the physical parameters that fully describe a unidirectional scan
    /// </summary>
    [ScanMode("Unidirectional XZ Scan")]
    public class UniDirXZScan : Scanmode
    {
        #region Constructors and Destructors

        /// <summary>
        /// Initializes a new instance of the <see cref="UniDirXZScan"/> class. 
                ...
                __dCycleTime)
        {
            ...
            // Dead time where the piezo is allowed to settle before a movement.
            this.m_iZPAfwd = this.m_iXPTfwd - this.m_iXPEfwd;
        ...
        protected override void CalculateNMScanCoordinates()
        {
            ...
            double[] _dZ = ScanUtility.LinSegment(this.m_iZPAfwd, this.m_iZPSfwd, this.m_iZCPfwd, 0.0, this.m_dZGLfwd);
