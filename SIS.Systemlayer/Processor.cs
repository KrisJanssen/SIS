// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Processor.cs" company="Kris Janssen">
...
namespace SIS.Systemlayer
{
    ...
    public static class Processor
    {
        ...
        /// <summary>
        /// Initializes static members of the <see cref="Processor"/> class.
        /// </summary>
        static Processor()
        {
            ...
            set
            {
                if (value < 1 || value > (IntPtr.Size * 8))
                {
                    throw new ArgumentOutOfRangeException(
                        "value", 
                        value, 
                        "must be in the range [0, " + (IntPtr.Size * 8).ToString() + "]");
                }
        ...
        /// The convert.
        /// </summary>
        /// <param name="wProcessorArchitecture">
        /// The w processor architecture.
        /// </param>
        /// <returns>
        /// The <see cref="ProcessorArchitecture"/>.
        /// </returns>
        ...
        private static string GetCpuName()
        {
            ...
            try
            {
                hDiSet = NativeMethods.SetupDiGetClassDevsW(
                    ref processorClassGuid, 
                    null, 
                    IntPtr.Zero, 
                ...
                while (true)
                {
                    ...
                    if (!bResult)
                    {
                        ...
                        else
                        {
                            throw new Win32Exception(
                                "SetupDiEnumDeviceInfo returned false, GetLastError() = " + error.ToString());
                        }
                    }

                    uint lengthReq = 0;
                    bResult = NativeMethods.SetupDiGetDeviceInstanceIdW(
                        hDiSet, 
                        ref spDevinfoData, 
                        IntPtr.Zero, 
                        0, 
                    ...
                    if (lengthReq == 0)
                    {
                        NativeMethods.ThrowOnWin32Error(
                            "SetupDiGetDeviceInstanceIdW(1) returned false, but also 0 for lengthReq");
                    }
