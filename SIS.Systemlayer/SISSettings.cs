...
namespace SIS.Systemlayer
{
    ...
    /// otherwise specified.
    /// </summary>
    public sealed class SISSettings
    {
        #region Constants

        /// <summary>
        /// Whether or not SIS should inform the user of pre-release versions (Betas) of
        /// SIS                                                                   //.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// The state of whether SIS should automatically check for updates once per week.
        /// </summary>
        ...
        /// <summary>
        /// Written to the registry to advertise what directory SIS is installed to.
        /// </summary>
        /// <remarks>
        /// This is a SystemWide setting and may not be changed by non-admins.
        /// </remarks>
        ...
        /// <summary>
        /// Prevents a default instance of the <see cref="SISSettings"/> class from being created.
        /// </summary>
        private SISSettings()
        {
        }
