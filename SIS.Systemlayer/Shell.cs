// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Shell.cs" company="Kris Janssen">
...
namespace SIS.Systemlayer
{
    ...
    {
        /// <summary>
        /// Repairs the installation of SIS by replacing any files that have gone missing.
        ...
        /// <summary>
        /// Uses the shell to execute the command. This method must only be used by SIS
        /// and not by plugins.
        /// </summary>
        /// <param name="parent">
        ...
        /// <summary>
        /// Asynchronously restarts SIS.
        /// </summary>
        /// <remarks>
        /// This method does not restart SIS immediately. Instead, it waits
        /// for SIS to terminate and then restarts it. It does not perform
