// --------------------------------------------------------------------------------------------------------------------
// <copyright file="UI.cs" company="Kris Janssen">
...
namespace SIS.Systemlayer
{
    ...
    public static class UI
    {
        ...
        /// <summary>
        /// Gets a value indicating whether is our app active.
        /// </summary>
        ...
        public static Rectangle[] GetUpdateRegion(Control control)
        {
            ...
            Rectangle[] scans;
            int area;
            SISGraphics.GetRegionScans(hRgn, out scans, out area);
            GC.KeepAlive(control);
            return scans;
        }

        /// <summary>
        /// The get x scale factor.
        /// </summary>
        /// <returns>
        /// The <see cref="float"/>.
        /// </returns>
        ...
        /// <summary>
        /// The hide horizontal scroll bar.
        /// </summary>
        /// <param name="c">
        /// The c.
        /// </param>
        ...
        public static void ResumeControlPainting(Control control)
        {
            ...
            else
            {
                throw new InvalidOperationException(
                    "There was no previous matching SuspendControlPainting() for this control");
            }
        ...
        public static void SetFormOpacity(Form form, double opacity)
        {
            ...
            if ((exStyle & NativeConstants.GWL_EXSTYLE) != 0)
            {
                uint dwOldKey;
                uint dwOldFlags;
                bool result = SafeNativeMethods.GetLayeredWindowAttributes(
                    form.Handle, 
                    out dwOldKey, 
                    out bOldAlpha, 
                    out dwOldFlags);
        ...
        /// <summary>
        /// The invoke through modal trampoline.
        /// </summary>
        /// <param name="owner">
        /// The owner.
        /// </param>
        ...
        internal static void InvokeThroughModalTrampoline(IWin32Window owner, Procedure<IWin32Window> invokeMe)
        {
            using (Form modalityFix = new Form())
            {
                ...
                modalityFix.Shown += delegate(object sender, EventArgs e)
                    {
        ...
        /// <summary>
        /// The determine visual style class.
        /// </summary>
        /// <returns>
        /// The <see cref="VisualStyleClass"/>.
        /// </returns>
        ...
        /// <summary>
        /// The determine visual style class impl.
        /// </summary>
        /// <returns>
        /// The <see cref="VisualStyleClass"/>.
        /// </returns>
        private static VisualStyleClass DetermineVisualStyleClassImpl()
        {
            ...
            else if (!VisualStyleInformation.IsEnabledByUser)
            {
                vsClass = VisualStyleClass.Classic;
                     ...
                     && 0
                     == string.Compare(
                         VisualStyleInformation.DisplayName, 
                         "Aero style", 
                         StringComparison.InvariantCulture))
            {
                vsClass = VisualStyleClass.Aero;
                     ...
                     == string.Compare(
                         VisualStyleInformation.Company, 
                         "Microsoft Corporation", 
                         StringComparison.InvariantCulture)
                     && 0
                     == string.Compare(
                         VisualStyleInformation.Author, 
                         ...
                         StringComparison.InvariantCulture))
            {
                if (0
                    == string.Compare(
                        VisualStyleInformation.DisplayName, 
                        "Windows XP style", 
                        StringComparison.InvariantCulture) || // Luna
                    0
                    == string.Compare(
                        VisualStyleInformation.DisplayName, 
                        "Zune Style", 
                        StringComparison.InvariantCulture) || // Zune
                    0
                    == string.Compare(
                        VisualStyleInformation.DisplayName, 
                        "Media Center style", 
