// --------------------------------------------------------------------------------------------------------------------
// <copyright company="" file="Axis.cs">
//   
// </copyright>
// <summary>
...
namespace ZedGraph.ZedGraph
{
    ...
    public abstract class Axis : ISerializable, ICloneable
    {
        ...
        public float CalcSpace(Graphics g, GraphPane pane, float scaleFactor, out float fixedSpace)
        {
            ...
            if (this._isVisible)
            {
                bool hasTic = this.MajorTic.IsOutside || this.MajorTic._isCrossOutside || this.MinorTic.IsOutside
                ...
                if (!this.IsPrimary(pane))
                {
                    ...
                    if (this.MajorTic._isInside || this.MajorTic._isCrossInside || this.MinorTic._isInside
            ...
            if (!this.IsPrimary(pane))
            {
                ...
                else
                {
                    ...
                    if (this._scale._isLabelsInside)
                    {
                        ...
                        if (this._majorTic.IsOutside || this._majorTic._isCrossOutside || this._minorTic.IsOutside
                            || this._minorTic._isCrossOutside)
                        {
                            shiftPos -= ticSize;
                        }
                    }
                    else
                    {
                        ...
                        if (this._majorTic.IsInside || this._majorTic._isCrossInside || this._minorTic.IsInside
                            || this._minorTic._isCrossInside)
                        {
                            shiftPos += ticSize;
                        }
                    }
