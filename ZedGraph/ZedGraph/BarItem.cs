// --------------------------------------------------------------------------------------------------------------------
// <copyright company="" file="BarItem.cs">
//   
// </copyright>
// <summary>
            ...
            foreach (CurveItem curve in pane.CurveList)
            {
                ...
                if (bar != null)
                {
                    ...
                    for (int i = 0; i < points.Count; i++)
                    {
                        ...
                        float centerVal =
                            (float)valueHandler.BarCenterValue(bar, bar.GetBarWidth(pane), i, baseVal, curveIndex);
                        ...
                        label.Location.CoordinateFrame = (isVertical && curve.IsY2Axis)
