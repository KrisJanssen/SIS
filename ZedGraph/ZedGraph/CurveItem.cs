// --------------------------------------------------------------------------------------------------------------------
// <copyright company="" file="CurveItem.cs">
//   
// </copyright>
// <summary>
...
*/
        ...
        /// </remarks>
        /// <param name="point">
        /// A reference to the <see cref="PointPair"/> object to
        /// be added
        /// </param>
            ...
            GraphPane pane)
        {
            ...
            for (int i = 0; i < this.Points.Count; i++)
            {
                ...
                // Y value
                if (ignoreInitial && curY != 0 && curY != PointPair.Missing)
                {
                    ignoreInitial = false;
                }
        ...
        /// <summary>
        /// Returns a reference to the <see cref="Axis"/> object that is the "base"
        ...
        /// <summary>
        /// Returns a reference to the <see cref="Axis"/> object that is the "value"
        ...
        public float GetBarWidth(GraphPane pane)
        {
            ...
            {
                barWidth = (float)(((ErrorBarItem)this).Bar.Symbol.Size * pane.CalcScaleFactor());
            }
            ...
            else
            {
                ...
                float denom = numBars * (1.0F + pane._barSettings.MinBarGap) - pane._barSettings.MinBarGap
                              + pane._barSettings.MinClusterGap;
                if (denom <= 0)
                {
                    denom = 1;
                }
