// --------------------------------------------------------------------------------------------------------------------
// <copyright company="" file="CurveList.cs">
//   
// </copyright>
// <summary>
                ...
                for (int i = 0; i < this.maxPts; i++)
                {
                    ...
                    foreach (BarItem barItem in tempList)
                    {
                        barItem.Bar.DrawSingleBar(
                            ...
                            0, 
                            i, 
                            ((BarItem)barItem).GetBarWidth(pane), 
                            scaleFactor);
                    }
                }
            }
...
*/
        ...
        /// </param>
        /// <returns>
        /// The zero-based index of the specified <see cref="CurveItem"/>,
        /// or -1 if the <see cref="CurveItem"/> is not in the list
        /// </returns>
