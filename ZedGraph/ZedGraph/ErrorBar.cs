// --------------------------------------------------------------------------------------------------------------------
// <copyright company="" file="ErrorBar.cs">
//   
// </copyright>
// <summary>
...
namespace ZedGraph.ZedGraph
{
    ...
    public class ErrorBar : ICloneable, ISerializable
    {
        ...
        /// Indicates that the <see cref="ErrorBar"/> should be drawn
            ...
            float scaleFactor)
        {
            ...
            {
                using (
                    Pen pen = !curve.IsSelected
                                  ? new Pen(this._color, this._penWidth)
