// --------------------------------------------------------------------------------------------------------------------
// <copyright company="" file="Fill.cs">
//   
// </copyright>
// <summary>
...
namespace ZedGraph.ZedGraph
{
    ...
    public class Fill : ISerializable, ICloneable
    {
        ...
        /// </summary>
        /// <param name="blend">
        /// The <see cref="ColorBlend"/> object that defines the colors
        ...
        /// </summary>
        /// <param name="colors">
        /// The array of <see cref="Color"/> objects that defines the colors
        /// along the gradient.
        /// </param>
        ...
        /// </summary>
        /// <param name="brush">
        /// The <see cref="Brush"/> to use for fancy fills.  Typically, this would
        /// be a <see cref="LinearGradientBrush"/> or a <see cref="TextureBrush"/> class
        /// </param>
        ...
        public bool IsGradientValueType
        {
            get
            {
                return this._type == FillType.GradientByX || this._type == FillType.GradientByY
        ...
        /// </param>
        /// <param name="rect">
        /// The <see cref="RectangleF"/> struct specifying the area
        /// to be filled
        /// </param>
                ...
                else if (this.IsGradientValueType)
                {
                    if (dataValue != null)
                    {
                        if (!this._secondaryValueGradientColor.IsEmpty)
                        {
                            ...
                            Fill tmpFill = new Fill(
                                this._secondaryValueGradientColor, 
                                this.GetGradientColor(dataValue), 
                                this._angle);
                    ...
                    else if (this._rangeDefault != double.MaxValue)
                    {
                        if (!this._secondaryValueGradientColor.IsEmpty)
                        {
                            ...
                            Fill tmpFill = new Fill(
                                this._secondaryValueGradientColor, 
                                this.GetGradientColor(this._rangeDefault), 
                                this._angle);
                            return tmpFill.MakeBrush(rect);
                        }
                        else
        ...
        private Brush ScaleBrush(RectangleF rect, Brush brush, bool isScaled)
        {
            if (brush != null)
            {
                ...
                else if (brush is LinearGradientBrush)
                {
                    ...
                    if (isScaled)
                    {
                        linBrush.ScaleTransform(
                            rect.Width / linBrush.Rectangle.Width, 
                            rect.Height / linBrush.Rectangle.Height, 
                            MatrixOrder.Append);
                        linBrush.TranslateTransform(
                            rect.Left - linBrush.Rectangle.Left, 
                            rect.Top - linBrush.Rectangle.Top, 
                            MatrixOrder.Append);
                    }
                    else
                    {
                ...
                else if (brush is TextureBrush)
                {
                    ...
                    if (isScaled)
                    {
                        texBrush.ScaleTransform(
                            rect.Width / texBrush.Image.Width, 
                            rect.Height / texBrush.Image.Height, 
                            MatrixOrder.Append);
