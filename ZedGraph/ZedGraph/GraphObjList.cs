// --------------------------------------------------------------------------------------------------------------------
// <copyright company="" file="GraphObjList.cs">
//   
// </copyright>
// <summary>
...
*/
        ...
        /// </param>
        /// <param name="zOrder">
        /// A <see cref="ZOrder"/> enumeration that controls
        ...
        /// </param>
        /// <returns>
        /// true if the mouse point is within a <see cref="GraphObj"/> bounding
        /// box, false otherwise.
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// The zero-based index of the specified <see cref="GraphObj"/>,
        /// or -1 if the <see cref="GraphObj"/> is not in the list
        /// </returns>
