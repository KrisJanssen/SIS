// --------------------------------------------------------------------------------------------------------------------
// <copyright company="" file="Legend.cs">
//   
// </copyright>
// <summary>
...
namespace ZedGraph.ZedGraph
{
    ...
    public class Legend : ICloneable, ISerializable
    {
        ...
        public void CalcRect(Graphics g, PaneBase pane, float scaleFactor, ref RectangleF tChartRect)
        {
            ...
            float totLegHeight = (float)Math.Ceiling((double)nCurve / (double)this._hStack) * this._legendItemHeight;
        ...
        /// </param>
        /// <param name="index">
        /// The index number of the <see cref="CurveItem"/> legend
        ...
        /// </param>
        /// <returns>
        /// true if the mouse point is within the <see cref="Legend"/> bounding
        /// box, false otherwise.
        /// </returns>
