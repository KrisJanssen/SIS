// --------------------------------------------------------------------------------------------------------------------
// <copyright company="" file="LogScale.cs">
//   
// </copyright>
// <summary>
...
namespace ZedGraph.ZedGraph
{
    ...
    internal class LogScale : Scale, ISerializable
    {
        ...
        /// new instance of <see cref="LogScale"/>
        /// </param>
        ...
        public override void PickScale(GraphPane pane, Graphics g, float scaleFactor)
        {
            ...
            if (this._minAuto)
            {
                this._min = Math.Pow((double)10.0, Math.Floor(Math.Log10(this._min)));
            }

            if (this._maxAuto)
            {
                this._max = Math.Pow((double)10.0, Math.Ceiling(Math.Log10(this._max)));
            }
        }
