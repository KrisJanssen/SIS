// --------------------------------------------------------------------------------------------------------------------
// <copyright company="" file="MasterPane.cs">
//   
// </copyright>
// <summary>
...
*/
        ...
        /// </summary>
        /// <param name="pane">
        /// A reference to the <see cref="GraphPane"/> object to
        /// be added
        /// </param>
        ...
        /// </param>
        /// <remarks>
        /// The <see cref="SetLayout(Graphics,PaneLayout)"/> method (and overloads) is
        ...
        public void DoLayout(Graphics g)
        {
            ...
            else
            {
                ...
                int rows, cols, root = (int)(Math.Sqrt((double)count) + 0.9999999);
        ...
        /// </param>
        /// <returns>
        /// A <see cref="GraphPane"/> object that contains the mouse point, or
        /// null if no <see cref="GraphPane"/> was found.
        /// </returns>
        ...
        /// </summary>
        /// <remarks>
        /// This method uses a <see cref="PaneLayout"/> enumeration to describe the type of layout
        ...
        /// A <see cref="PaneLayout"/> enumeration that describes how
        /// the panes should be laid out within the <see cref="PaneBase.Rect"/>.
        /// </param>
        /// <seealso cref="SetLayout(Graphics,int,int)"/>
        /// <seealso cref="SetLayout(Graphics,bool,int[])"/>
        /// <seealso cref="SetLayout(Graphics,bool,int[],float[])"/>
        ...
        /// </param>
        /// <param name="rows">
        /// The number of rows of <see cref="GraphPane"/> objects
        /// to include in the layout
        /// </param>
        /// <param name="columns">
        /// The number of columns of <see cref="GraphPane"/> objects
        /// to include in the layout
        /// </param>
        /// <seealso cref="SetLayout(Graphics,PaneLayout)"/>
        /// <seealso cref="SetLayout(Graphics,bool,int[])"/>
        ...
        /// number of columns in each row are specified in <see paramref="countList"/>.
        /// </param>
        ...
        /// Specifies whether the number of columns in each row, or
        /// the number of rows in each column will be specified.  A value of true indicates the
        /// number of columns in each row are specified in <see paramref="_countList"/>.
        /// </param>
        /// <param name="countList">
        /// An integer array specifying either the number of columns in
        /// each row or the number of rows in each column, depending on the value of
        ...
        internal void DoLayout(Graphics g, bool isColumnSpecified, int[] countList, float[] proportion)
        {
            ...
            if (isColumnSpecified)
            {
                ...
                for (int rowNum = 0; rowNum < rows; rowNum++)
                {
                    ...
                    float height = (innerRect.Height - (float)(rows - 1) * scaledInnerGap) * propFactor;
            ...
            else
            {
                ...
                for (int colNum = 0; colNum < columns; colNum++)
                {
                    ...
                    float width = (innerRect.Width - (float)(columns - 1) * scaledInnerGap) * propFactor;
