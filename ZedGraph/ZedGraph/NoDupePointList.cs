// --------------------------------------------------------------------------------------------------------------------
// <copyright company="" file="NoDupePointList.cs">
//   
// </copyright>
// <summary>
...
namespace ZedGraph.ZedGraph
{
    ...
    public class NoDupePointList : List<DataPoint>, IPointList, IPointListEdit
    {
        ...
        /// </remarks>
        /// <param name="pane">
        /// The <see cref="GraphPane"/> into which the data
        /// will be plotted. 
        /// </param>
        /// <param name="xAxis">
        /// The <see cref="Axis"/> class to be used in the X direction
        /// for plotting these data.  This can be an <see cref="XAxis"/> or a 
        /// <see cref="X2Axis"/>.
        /// </param>
        /// <param name="yAxis">
        /// The <see cref="Axis"/> class to be used in the Y direction
