// --------------------------------------------------------------------------------------------------------------------
// <copyright company="" file="PointPairList.cs">
//   
// </copyright>
// <summary>
...
*/
        ...
        /// </summary>
        /// <param name="point">
        /// The <see cref="PointPair"/> object to
        /// be added
        /// </param>
        ...
        /// A reference to the <see cref="PointPairList"/> object to
        /// be added
        /// </param>
        ...
        /// </summary>
        /// <remarks>
        /// Equality is based on equal count of <see cref="PointPair"/> items, and
        ...
        /// </param>
        /// <returns>
        /// The zero-based index of the specified <see cref="PointPair"/>,
        /// or -1 if the <see cref="PointPair"/> is not in the list
        /// </returns>
		...
		*/
        ...
        /// </summary>
        /// <remarks>
        /// The output <see cref="PointPairList"/> will cover the
        /// same X range of data as the original dataset.
        /// </remarks>
        /// <param name="points">
        /// An <see cref="IPointList"/> instance containing
        ...
        /// </param>
        /// <returns>
        /// A new <see cref="PointPairList"/> containing the resultant
        /// data fit.
        /// </returns>
        ...
        /// values in the <see cref="PointPairList"/>.
        /// </param>
        ...
        /// <param name="sumList">
        /// A reference to the <see cref="PointPairList"/> object to
        /// be summed into the this <see cref="PointPairList"/>.
        /// </param>
