// --------------------------------------------------------------------------------------------------------------------
// <copyright company="" file="Selection.cs">
//   
// </copyright>
// <summary>
...
namespace ZedGraph.ZedGraph
{
    ...
    public class Selection : CurveList
    {
        ...
        /// </summary>
        /// <param name="master">
        /// The <see cref="MasterPane"/> that is the "owner"
        /// of the <see cref="CurveItem"/>'s.
        /// </param>
        /// <param name="ci">
    ...
    // Define a "Contains" method so that this class works with .Net 1.1 or 2.0
        ...
        /// true to trigger a <see cref="SelectionChangedEvent"/>,
        /// false otherwise.
        /// </param>
