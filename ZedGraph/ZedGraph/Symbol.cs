// --------------------------------------------------------------------------------------------------------------------
// <copyright company="" file="Symbol.cs">
//   
// </copyright>
// <summary>
...
namespace ZedGraph.ZedGraph
{
    ...
    public class Symbol : ICloneable, ISerializable
    {
        ...
        /// </summary>
        /// <param name="type">
        /// A <see cref="SymbolType"/> enum value
        /// indicating the shape of the symbol
        /// </param>
        /// <param name="color">
        /// A <see cref="Color"/> value indicating
        ...
        /// Indicates that the <see cref="Symbol"/> should be drawn
            ...
            PointPair dataValue)
        {
            ...
            if (this._isVisible && this.Type != SymbolType.None && x < 100000 && x > -100000 && y < 100000
                && y > -100000)
            {
                SmoothingMode sModeSave = g.SmoothingMode;
                if (this._isAntiAlias)
        ...
        public GraphicsPath MakePath(Graphics g, float scaleFactor)
        {
            ...
            switch (
                this._type == SymbolType.Default || (this._type == SymbolType.UserDefined && this._userSymbol == null)
                    ? Default.Type
                    : this._type)
            {
        ...
        /// </param>
        /// <param name="brush">
        /// A <see cref="Brush"/> class representing a default solid brush for this symbol
