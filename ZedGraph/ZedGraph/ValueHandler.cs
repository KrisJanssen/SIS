// --------------------------------------------------------------------------------------------------------------------
// <copyright company="" file="ValueHandler.cs">
//   
// </copyright>
// <summary>
...
namespace ZedGraph.ZedGraph
{
    ...
    public class ValueHandler
    {
        ...
        /// A <see cref="bool"/> flag to indicate whether or
        ...
        /// </param>
        /// <param name="baseVal">
        /// A <see cref="double"/> value representing the value
        /// for the independent axis.
        /// </param>
        /// <param name="lowVal">
        /// A <see cref="double"/> value representing the lower
        /// value for the dependent axis.
        /// </param>
        /// <param name="hiVal">
        /// A <see cref="double"/> value representing the upper
        /// value for the dependent axis.
        /// </param>
        /// <returns>
            ...
            out double hiVal)
        {
            ...
            if (curve is BarItem
                && (pane._barSettings.Type == BarType.Stack || pane._barSettings.Type == BarType.PercentStack))
            {
                ...
                if (baseVal == PointPair.Missing || lowVal == PointPair.Missing || hiVal == PointPair.Missing)
                {
                    return false;
                }
                else
        ...
        /// </summary>
        /// <param name="curve">
        /// The <see cref="CurveItem"/> representing the
        /// bar of interest.
        /// </param>
        /// <param name="barWidth">
        /// The width of each individual bar. This can be calculated using
        /// the <see cref="CurveItem.GetBarWidth"/> method.
        /// </param>
        /// <param name="iCluster">
        ...
        /// </param>
        /// <param name="iOrdinal">
        /// The ordinal position of the <see cref="CurveItem"/> of interest.
        ...
        public double BarCenterValue(CurveItem curve, float barWidth, int iCluster, double val, int iOrdinal)
        {
            ...
            if (curve is ErrorBarItem || curve is HiLowBarItem || curve is OHLCBarItem
            ...
            else
            {
                ...
                float centerPix = baseAxis.Scale.Transform(curve.IsOverrideOrdinal, iCluster, val) - clusterWidth / 2.0F
                                  + clusterGap / 2.0F + iOrdinal * (barWidth + barGap) + 0.5F * barWidth;
