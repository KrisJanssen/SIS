// --------------------------------------------------------------------------------------------------------------------
// <copyright company="" file="XDate.cs">
//   
// </copyright>
// <summary>
...
*/
        ...
        /// </returns>
        public static double CalendarDateToXLDate(
            int year, 
            int month, 
            int day, 
            int hour, 
        ...
        /// (see <see cref="XLDayMin"/> and <see cref="XLDayMax"/>)
        /// </returns>
        ...
        /// obj
        /// </param>
        /// is either an <see cref="XDate"/> structure or
            ...
            double millisecond)
        {
            ...
            return Math.Floor(365.25 * ((double)year + 4716.0)) + Math.Floor(30.6001 * (double)(month + 1))
                   + (double)day + B - 1524.5 + hour / HoursPerDay + minute / MinutesPerDay + second / SecondsPerDay
        ...
        /// The corresponding XL date, expressed in double floating point format
        /// </returns>
        private static double _CalendarDateToXLDate(
            int year, 
            int month, 
            int day, 
            int hour, 
