// --------------------------------------------------------------------------------------------------------------------
// <copyright company="" file="Y2AxisList.cs">
//   
// </copyright>
// <summary>
...
namespace ZedGraph.ZedGraph
{
    ...
    public class Y2AxisList : List<Y2Axis>, ICloneable
    {
        ...
        /// </param>
        /// <returns>
        /// An integer representing the ordinal position of the new <see cref="Y2Axis"/> in
        ...
        /// you would also need to set the <see cref="CurveItem.IsY2Axis"/> property to true.
        /// </returns>
