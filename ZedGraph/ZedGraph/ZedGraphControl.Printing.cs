// --------------------------------------------------------------------------------------------------------------------
// <copyright company="" file="ZedGraphControl.Printing.cs">
//   
// </copyright>
// <summary>
...
namespace ZedGraph.ZedGraph
{
    ...
    partial class ZedGraphControl
    {
        ...
        /// </param>
        /// <param name="e">
        /// A <see cref="PrintPageEventArgs"/> instance providing
        ...
        private void Graph_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            mPane.ReSize(
                e.Graphics, 
                new RectangleF(e.MarginBounds.Left, e.MarginBounds.Top, newSize.Width, newSize.Height));
