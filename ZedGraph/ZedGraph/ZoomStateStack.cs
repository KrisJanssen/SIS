// --------------------------------------------------------------------------------------------------------------------
// <copyright company="" file="ZoomStateStack.cs">
//   
// </copyright>
// <summary>
...
namespace ZedGraph.ZedGraph
{
    ...
    public class ZoomStateStack : List<ZoomState>, ICloneable
    {
        ...
        /// </summary>
        /// <param name="pane">
        /// The <see cref="GraphPane"/> object to which the scale range
        /// information should be copied.
        /// </param>
        /// <returns>
        /// The <see cref="ZoomState"/> object that was "popped" from the stack and applied
        ...
        /// </param>
        /// <returns>
        /// The <see cref="ZoomState"/> object at the bottom of the stack that was applied
        /// to the specified <see cref="GraphPane"/>.  null if no <see cref="ZoomState"/> was
        /// available (the stack was empty).
        /// </returns>
        ...
        /// </summary>
        /// <param name="pane">
        /// The <see cref="GraphPane"/> object from which the scale range
        /// information should be copied.
        /// </param>
        /// <param name="type">
        /// A <see cref="ZoomState.StateType"/> enumeration that indicates whether this
